...
sim_name = "sv"
triangle_ws = pl.Path("./temp/_sv_triangle")
data_path = pl.Path("../data/synthetic_valley")
...
def get_mf6gwf_sim(sim_ws, lake_concentration=1.0, recharge_concentration=0.0):
    name = "flow"
...
def get_mf6gwt_sim(sim_ws, initial_concentration=0.0):
    name = "trans"
